...
function Content() {
  ...
  useEffect(() => {
    console.log("Fetching playlist of id="+playListId);
    spotofyApi
      .getPlaylist(playListId)
      .then(data => {
        setPlaylist(data.body);
      })
      .catch(error => console.log("Error in updating playlist:",error));
  }, [spotofyApi, playListId])
    ...
    <div className="flex-grow h-screen overflow-y-scroll scrollbar-hide">
      <header className='absolute top-5 right-8'>
        <div 
          ...
          space-x-3 opacity-90 hover:opactiy-80 cursor-pointer 
